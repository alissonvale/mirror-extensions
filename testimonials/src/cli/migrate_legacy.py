"""CLI: `testimonials migrate-legacy --source <path>` (US-04)."""
...
def _print_result(result: MigrationResult) -> None:
    ...
    print(
        f"  ext_testimonials_records   "
        f"{result.imported:>4} {verb_imported}, "
        f"{result.skipped:>4} {verb_skipped}"
    )
    print()
    print(f"Total: {result.imported} rows {verb_imported}.")
